...
router.post('/projectEmail', function(req, res) {
    ...
    project_collection.find({
        ...
        data.forEach(function(data) {
            ...
            html += '<div style="padding-top:10px; margin-top:10px; border-top:1px solid #eee; font-size: 85%; color:#8C8C8C">&copy; 2016 Singsys Pvt Ltd <br/>Systems Department - Singsys<p>This email is generated by a program but you can reply to this email in case you find any kind of issue with the information included in this email. Your replies to this email will be inboxed to concerned person from Systems Department.</p></div></div></body></html>';
            var mailOptions = {
                from: 'Systems Department <noreply@singsys.com>',
                to: req.body.emailTo,
                cc: req.body.emailCc,
                replyTo: 'shashwat@singsys.com,nitish@singsys.com,nirmal@singsys.com,shantanu@singsys.com,abhishekdubey@singsys.com',
                ...
                exit: function(exitCode) {
                    ...
                    if (exitCode != 0) {
                        var mailOptions = {
                            ...
                            to: user_email,
                            cc: 'shashwat@singsys.com, nirmal@singsys.com, nitish@singsys.com,shantanu@singsys.com,abhishekdubey@singsys.com',
