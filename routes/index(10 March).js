 ...
 request.post(url, function(error, response, html) {
					...
					if(html){
					    console.log(html);
                                    ...
                                    var command = 'cd "' + currentDirectoryTraverse + '" && git clone -b ' + createBranchFrom + ' http://automated:m07Q1CJ70LpMWm7L2y6y@git.singsys.com/' + result.group + '/' + result.unique_identifier + '.git';
                                }
                                console.log(command);
                                ssh.exec(command, {
                                    out: function(stdout) {
